---
seoTitle: "Core to Floor — Emsculpt Neo + Emsella in Aventura, FL | Ideal Medical & Wellness"
seoDescription: "Core to Floor in Aventura combines Emsculpt Neo and Emsella HIFEM technology to build muscle and strengthen the entire core in 30-minute sessions. Individual results vary."

heroTitle: "CORE TO FLOOR\nEMSCULPT NEO\n+ EMSELLA"
heroLead: "Emsculpt Neo + Emsella together use high-intensity focused electromagnetic (HIFEM) technology to build muscle in just 30 minutes. When combined, we can strengthen the entire core of the body — all from the comfort of a single visit."
heroImage: "/assets/images/services/core-to-floor/hero.webp"
heroImageAlt: "Person doing core and stability training on a mat"
...
simpleWhatIs:
  ...
  bullets:
    - "Reduced back discomfort from a stronger core"
...
# === Banner (idealmedical Core to Floor BTL ad — large, as on original site) ===
banner:
  image: "/assets/images/services/shared/core-to-floor-banner.webp"
  imageAlt: "Emsculpt Core to Floor Therapy — two HIFEM procedures strengthen, firm, and tone the abdomen and pelvic muscles; 16% increase in muscle mass and 95% patient satisfaction. Individual results vary."
